...
/* -------------------------------------------------------------------------- */
/*  Hero (v4 — 3D forge core + tilting dashboard panel)                       */
/* -------------------------------------------------------------------------- */
...
export function Hero3D() {
  ...
  return (
    ...
    >
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute left-1/2 top-[-8%] -z-20 h-[460px] w-[760px] -translate-x-1/2 rounded-full bg-iris-600/10 blur-[140px]"
      />
      <div
        aria-hidden
      ...
      {/* ------------------------------------------------------------------ */}
      {/*  The Forge — 3D centerpiece behind the headline                     */}
      {/* ------------------------------------------------------------------ */}
      <SceneCanvas
        className="pointer-events-none absolute left-1/2 top-6 -z-10 h-[700px] w-[700px] -translate-x-1/2 opacity-70 md:top-2"
        camera={{ position: [0, 0, 7], fov: 42 }}
        fallback={
          <>
            <div className="absolute left-1/2 top-1/2 h-[460px] w-[700px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-iris-600/20 blur-[140px]" />
      ...
      >
        ...
        <pointLight position={[5, 4, 6]} color="#8b5cf6" intensity={40} />
        <pointLight position={[-5, -3, 5]} color="#38bdf8" intensity={26} />
        <ForgeCore />
      </SceneCanvas>
      ...
      <div className="container-rf">
        ...
        {/* ---------------------------------------------------------------- */}
        {/*  Product mockup — floating 3D panel                              */}
        {/* ---------------------------------------------------------------- */}
...
/* -------------------------------------------------------------------------- */
/*  Pointer-tracking 3D tilt wrapper for the dashboard panel                  */
/* -------------------------------------------------------------------------- */
...
function TiltPanel({
  ...
  // Pointer position normalised to [-0.5, 0.5] across the panel.
  const px = useMotionValue(0)
  const py = useMotionValue(0)

  const rotateX = useSpring(
    useTransform(py, [-0.5, 0.5], [TILT_MAX, -TILT_MAX]),
    TILT_SPRING,
  )
  const rotateY = useSpring(
    useTransform(px, [-0.5, 0.5], [-TILT_MAX, TILT_MAX]),
    TILT_SPRING,
  )
